...
export default function UserSidebarProfile() {
  ...
  const menuItems = [
    { name: 'My Profile', icon: User, href: '/UserPages/ProfilePage' },
    { name: 'Notifications', icon: Bell, href: '/UserPages/Notification' },
    { name: 'FAQ', icon: HelpCircle, href: '/UserPages/FAQ' },
    { name: 'About App', icon: Info, href: '/UserPages/About' },
  ]
