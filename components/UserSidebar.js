    ...
    <>
      ...
      >
        ...
        <nav className="space-y-3">
          {/* <Link
            href="/UserPages/ClientPage"
            className={`block py-2 px-3 rounded 
              ${
                isActive('/UserPages/ClientPage')
          ...
          <Link
            ...
            `}
          >
            <UserPlus size={16} className="inline-block mb-1" /> View Histroy
          </Link>
        </nav>

        {/* Profile & Logout */}
        <div className="mt-auto pt-6 space-y-3">
          <Link href="/UserPages/ProfilePage">
